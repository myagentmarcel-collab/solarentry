...
export default function PrivacyPage() {
  return (
    <article className="mx-auto max-w-2xl rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
      <h1 className="text-2xl font-semibold text-slate-900">Privacy note</h1>
